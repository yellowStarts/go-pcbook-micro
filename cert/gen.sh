...
openssl req -newkey rsa:4096 -nodes -keyout client-key.pem -out client-req.pem -subj "/C=CN/ST=FJ/L=QZ/O=Abbb/OU=Computer/CN=*.abbb.com/emailAddress=abbb@gmail.com"
